...
meta:
  - name: keywords
    content: netty chat group case
  - name: description
    content: 本文通过实战演练，学习了如何使用Netty开发一个群聊天室。
categories:
  - 后端开发
  - 分布式
tags:
...
![image-20220428000626813](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220428000626813.png)



![image-20220428000645018](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220428000645018.png)



![image-20220428000707355](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220428000707355.png)
