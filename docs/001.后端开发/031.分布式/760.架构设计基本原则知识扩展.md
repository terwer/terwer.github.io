...
![image-20220416013406846](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220416013406846.png)
...
![image-20220416095553638](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220416095553638.png)

可以看到，采用继承会产生很多的子类，并且新增动力源和颜色都要修改代码违背了开闭原则。

采用组合模式可以很好的解决：

![image-20220416095947434](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220416095947434.png)
