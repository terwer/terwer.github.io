...
oldlink: /pages/790154/
permalink: /post/netty-codec.html
meta:
  - name: keywords
    content: netty codec
  - name: description
    content: 本文介绍了Netty编解码器的继承体系、常用API以及实际应用。
categories:
  - 后端开发
  - 分布式
tags:
...
2. 解码（Decode）称为反序列化，它将从网络、磁盘等读取的字节数组还原成原始对象（通常是原始对象），以方便后面的业务逻辑操作。
   ...
   ![image-20220423190741342](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220423190741342.png)
...
> 如果图片无法显示，请看这里
>
> ![image-20220425200951629](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220425200951629.png)
...
![image-20220426211349610](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220426211349610.png)
...
> 如果图片无法显示，请看这里
>
> ![image-20220426211958116](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220426211958116.png)
...
- 代码实现
  ...
  ![image-20220426223922272](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220426223922272.png)
...
> 如果图片无法查看，请看这里
>
> ![image-20220427013952540](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220427013952540.png)
...
![image-20220427020348463](https://cdn.jsdelivr.net/gh/terwer/upload/img/image-20220427020348463.png)
