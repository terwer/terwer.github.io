...
meta:
  - name: keywords
    content: 编译 开发工具 Java 源码 虚拟机
  - name: description
    content: >-
      本文介绍了在 macOS 环境下准备构建 OpenJDK 的步骤，包括安装必要的软件和获取源码。文章详细解释了目录结构和配置参数，涵盖了
      OpenJDK 中的各个组件和工具，如 hotspot、langtools、jaxp、jaxws、nashorn、corba
      等。还提到了加速编译的方法，以及配置参数的意义和使用方式。
tags:
  - 编译
  - 开发工具
  - Java
...
---
本文介绍了在 macOS 环境下准备构建 OpenJDK 的步骤，包括安装必要的软件和获取源码。文章详细解释了目录结构和配置参数，涵盖了 OpenJDK 中的各个组件和工具，如 hotspot、langtools、jaxp、jaxws、nashorn、corba 等。还提到了加速编译的方法，以及配置参数的意义和使用方式。
