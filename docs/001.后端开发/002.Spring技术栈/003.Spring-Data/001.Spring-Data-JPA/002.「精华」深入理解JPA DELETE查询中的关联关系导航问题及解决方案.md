...
meta:
  - name: description
    content: >-
      本文分析了JPA执行DELETE查询时，因在JPQL语句中通过关联关系导航（如`e.relation.field`）而引发的SQL语法错误。根本原因在于JPA会将此类导航转换为包含JOIN的复杂SQL，而DELETE语句中的JOIN操作存在数据库兼容性和性能问题。
categories:
  - 后端开发
  - Spring技术栈
  - Spring-Data
  - Spring-Data-JPA
permalink: >-
  /post/essence-provides-an-indepth-understanding-of-the-relationship-navigation-issues-and-z22ktb1.html
author:
  name: terwer
  link: ''
---
