...
meta:
  - name: keywords
    content: 中科大 软件源 mirror install zsh
  - name: description
    content: >-
      设置中科大源注意_需要先切换root用户su#===================================#镜像源设置开始#===================================#添加中科大centos镜像源cpetcyumreposdcentosbaserepoetcyumreposdcentosbaserepobaksedes_^mirrorlist=_#mirrorlist=_ges_^#baseurl=http_mirrorcentosorgcentos_baseurl=
categories:
  - 默认分类
tags:
  - 中科大
