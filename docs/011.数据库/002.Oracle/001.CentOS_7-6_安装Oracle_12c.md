...
permalink: /post/centos_76_-install-oracle_12c-11dy4t.html
meta:
  - name: keywords
    content: 下载 地址 oracle centos linux oracle12c 整个 过程 可能
  - name: description
    content: >-
      下载地址_http_wwworaclecomtechnetworkdatabaseenterpriseeditiondownloadsindexhtmlhttps_wwworaclecomtechnetworkdatabaseenterpriseeditiondownloadsoracleclinuxhtml整个过程下载可能会比较慢最好是抓取下载链接然后使用wget下载例如​[root@terwergreenopt]#wgethttps_downloadoraclecomotnlinuxoraclecli
categories:
  - 默认分类
tags:
  - 下载
