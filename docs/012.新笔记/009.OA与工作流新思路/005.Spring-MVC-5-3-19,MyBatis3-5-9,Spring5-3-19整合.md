...
meta:
  ...
  - name: description
    content: Spring-MVC-5-3-19,MyBatis3-5-9,Spring5-3-19整合。IDEA->new->Project，创建一个Maven的webapp项目，选择 org.apache.maven的webapp骨架。
categories:
  - 新笔记
  - OA与工作流新思路
tags:
...
![image-20220528150924649](https://cdn.jsdelivr.net/gh/terwer/upload/img/20220528150926.png)
