...
meta:
  - name: keywords
    content: spring struts hibernate
  - name: description
    content: SSH框架整合续之实现基本的增删改查。IDEA->new->Project，创建一个Maven的webapp项目，选择 org.apache.maven的webapp骨架。
categories:
  - 新笔记
  - OA与工作流新思路
tags:
...
![image-20220528162042574](https://cdn.jsdelivr.net/gh/terwer/upload/img/20220528162043.png)
...
![image-20220528162527155](https://cdn.jsdelivr.net/gh/terwer/upload/img/20220528162527.png)
...
![image-20220528162835878](https://cdn.jsdelivr.net/gh/terwer/upload/img/20220528162836.png)
...
![image-20220528164426480](https://cdn.jsdelivr.net/gh/terwer/upload/img/20220528164426.png)
