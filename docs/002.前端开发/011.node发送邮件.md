---
title: node发送邮件
date: 2022-07-09 23:35:00
permalink: /post/node-send-email.html
meta:
  - name: keywords
    content: node mail
  - name: description
    content: node发送邮件代码mailmjsimportnodemailerfromnodemailerexportdefaultasyncfunctionsendmailtotitlemsg{//创建transporterconsttransporternodemailercreatetransport{hostsmtpqqcom//邮箱的smtp地址auth{usertangyouwei@qqcom//邮箱的smtp地址passprocessenvqqmail_smtp_token//邮箱授权码}}//配置邮件
categories:
  - 前端开发
tags:
  - node
